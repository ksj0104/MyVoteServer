...
```text
C:\Users\seong\PycharmProjects\MyVote\artifacts\semantic-translation-ready-2026-09-16\MyVote-Speaker-Update.zip
```
...
`검증한 업데이트`와 `gateway.listening` 로그의 `engine_revision`이 **`semantic-translation-2026-09-16`**인지 확인한다. 서버 터미널은 실행해 둔다. 기존 연결 주소는 `192.168.219.103:50051`이다.
...
```text
C:\Users\seong\PycharmProjects\MyVote\artifacts\windows-semantic-translation-2026-09-16\app\MyVote.Desktop.exe
```
